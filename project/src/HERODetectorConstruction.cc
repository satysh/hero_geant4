...
G4VPhysicalVolume *HERODetectorConstruction::Construct()
{
    ...
    BorScinMat->AddElement(nist->FindOrBuildElement("C"), 23. * perCent);
    BorScinMat->AddElement(nist->FindOrBuildElement("H"), 27. * perCent);
    BorScinMat->AddElement(nist->FindOrBuildElement("B"), 50. * perCent);
